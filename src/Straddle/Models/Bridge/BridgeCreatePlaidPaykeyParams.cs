...
/// </summary>
public record class BridgeCreatePlaidPaykeyParams : ParamsBase
{
    ...
    public BridgeCreatePlaidPaykeyParams() { }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public BridgeCreatePlaidPaykeyParams(
        BridgeCreatePlaidPaykeyParams bridgeCreatePlaidPaykeyParams
    )
        : base(bridgeCreatePlaidPaykeyParams)
    {
        this._rawBodyData = new(bridgeCreatePlaidPaykeyParams._rawBodyData);
    }
...
#pragma warning restore CS8618
    ...
    public static BridgeCreatePlaidPaykeyParams FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawHeaderData,
        IReadOnlyDictionary<string, JsonElement> rawQueryData,
        IReadOnlyDictionary<string, JsonElement> rawBodyData
    )
    ...
    public virtual bool Equals(BridgeCreatePlaidPaykeyParams? other)
    {
        if (other == null)
        {
            return false;
