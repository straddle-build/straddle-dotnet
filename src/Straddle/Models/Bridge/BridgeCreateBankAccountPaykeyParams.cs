...
/// </summary>
public record class BridgeCreateBankAccountPaykeyParams : ParamsBase
{
    ...
    public PaykeyConfiguration? Config
    {
        get
        {
            this._rawBodyData.Freeze();
            return this._rawBodyData.GetNullableClass<PaykeyConfiguration>("config");
        }
        init
        {
            if (value == null)
    ...
    public BridgeCreateBankAccountPaykeyParams() { }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public BridgeCreateBankAccountPaykeyParams(
        BridgeCreateBankAccountPaykeyParams bridgeCreateBankAccountPaykeyParams
    )
        : base(bridgeCreateBankAccountPaykeyParams)
    {
        this._rawBodyData = new(bridgeCreateBankAccountPaykeyParams._rawBodyData);
    }
...
#pragma warning restore CS8618
    ...
    public static BridgeCreateBankAccountPaykeyParams FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawHeaderData,
        IReadOnlyDictionary<string, JsonElement> rawQueryData,
        IReadOnlyDictionary<string, JsonElement> rawBodyData
    )
    ...
    public virtual bool Equals(BridgeCreateBankAccountPaykeyParams? other)
    {
        if (other == null)
        {
            return false;
