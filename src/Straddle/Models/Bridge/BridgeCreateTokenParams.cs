...
/// </summary>
public record class BridgeCreateTokenParams : ParamsBase
{
    ...
    public BridgeCreateTokenParams() { }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public BridgeCreateTokenParams(BridgeCreateTokenParams bridgeCreateTokenParams)
        : base(bridgeCreateTokenParams)
    {
        this._rawBodyData = new(bridgeCreateTokenParams._rawBodyData);
    }
...
#pragma warning restore CS8618
    ...
    public static BridgeCreateTokenParams FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawHeaderData,
        IReadOnlyDictionary<string, JsonElement> rawQueryData,
        IReadOnlyDictionary<string, JsonElement> rawBodyData
    )
    ...
    public virtual bool Equals(BridgeCreateTokenParams? other)
    {
        if (other == null)
        {
            return false;
