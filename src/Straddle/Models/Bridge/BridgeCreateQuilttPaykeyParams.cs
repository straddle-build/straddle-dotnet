...
/// </summary>
public record class BridgeCreateQuilttPaykeyParams : ParamsBase
{
    ...
    public BridgeCreateQuilttPaykeyParams() { }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public BridgeCreateQuilttPaykeyParams(
        BridgeCreateQuilttPaykeyParams bridgeCreateQuilttPaykeyParams
    )
        : base(bridgeCreateQuilttPaykeyParams)
    {
        this._rawBodyData = new(bridgeCreateQuilttPaykeyParams._rawBodyData);
    }
...
#pragma warning restore CS8618
    ...
    public static BridgeCreateQuilttPaykeyParams FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawHeaderData,
        IReadOnlyDictionary<string, JsonElement> rawQueryData,
        IReadOnlyDictionary<string, JsonElement> rawBodyData
    )
    ...
    public virtual bool Equals(BridgeCreateQuilttPaykeyParams? other)
    {
        if (other == null)
        {
            return false;
