...
[JsonConverter(typeof(JsonModelConverter<RevealedPaykey, RevealedPaykeyFromRaw>))]
public sealed record class RevealedPaykey : JsonModel
{
    /// <summary>
    ...
    public RevealedPaykey() { }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public RevealedPaykey(RevealedPaykey revealedPaykey)
        : base(revealedPaykey) { }
#pragma warning restore CS8618

    public RevealedPaykey(IReadOnlyDictionary<string, JsonElement> rawData)
    {
...
#pragma warning disable CS8618
    [SetsRequiredMembers]
    RevealedPaykey(FrozenDictionary<string, JsonElement> rawData)
    {
        this._rawData = new(rawData);
    }
#pragma warning restore CS8618

    /// <inheritdoc cref="RevealedPaykeyFromRaw.FromRawUnchecked"/>
    public static RevealedPaykey FromRawUnchecked(IReadOnlyDictionary<string, JsonElement> rawData)
    {
        return new(FrozenDictionary.ToFrozenDictionary(rawData));
    }
}

class RevealedPaykeyFromRaw : IFromRawJson<RevealedPaykey>
{
    /// <inheritdoc/>
    public RevealedPaykey FromRawUnchecked(IReadOnlyDictionary<string, JsonElement> rawData) =>
        RevealedPaykey.FromRawUnchecked(rawData);
}
