...
/// </summary>
public record class ReviewListParams : ParamsBase
{
    ...
    public ReviewListParams() { }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public ReviewListParams(ReviewListParams reviewListParams)
        : base(reviewListParams)
    {
        this.ID = reviewListParams.ID;
    }
...
#pragma warning restore CS8618
    ...
    public static ReviewListParams FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawHeaderData,
        IReadOnlyDictionary<string, JsonElement> rawQueryData,
        string id
    )
    ...
    public virtual bool Equals(ReviewListParams? other)
    {
        if (other == null)
        {
            return false;
