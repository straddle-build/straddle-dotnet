...
/// </summary>
public record class ReviewSetVerificationDecisionParams : ParamsBase
{
    ...
    public ReviewSetVerificationDecisionParams() { }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public ReviewSetVerificationDecisionParams(
        ReviewSetVerificationDecisionParams reviewSetVerificationDecisionParams
    )
        : base(reviewSetVerificationDecisionParams)
    {
        this.ID = reviewSetVerificationDecisionParams.ID;

        this._rawBodyData = new(reviewSetVerificationDecisionParams._rawBodyData);
    }
...
#pragma warning restore CS8618
    ...
    public static ReviewSetVerificationDecisionParams FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawHeaderData,
        IReadOnlyDictionary<string, JsonElement> rawQueryData,
        IReadOnlyDictionary<string, JsonElement> rawBodyData,
        string id
    ...
    public virtual bool Equals(ReviewSetVerificationDecisionParams? other)
    {
        if (other == null)
        {
            return false;
