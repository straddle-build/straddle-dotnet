...
/// </summary>
public record class PaykeyRefreshBalanceParams : ParamsBase
{
    ...
    public PaykeyRefreshBalanceParams() { }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public PaykeyRefreshBalanceParams(PaykeyRefreshBalanceParams paykeyRefreshBalanceParams)
        : base(paykeyRefreshBalanceParams)
    {
        this.ID = paykeyRefreshBalanceParams.ID;
    }
...
#pragma warning restore CS8618
    ...
    public static PaykeyRefreshBalanceParams FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawHeaderData,
        IReadOnlyDictionary<string, JsonElement> rawQueryData,
        string id
    )
    ...
    public virtual bool Equals(PaykeyRefreshBalanceParams? other)
    {
        if (other == null)
        {
            return false;
