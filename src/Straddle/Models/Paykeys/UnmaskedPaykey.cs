...
[JsonConverter(typeof(JsonModelConverter<UnmaskedPaykey, UnmaskedPaykeyFromRaw>))]
public sealed record class UnmaskedPaykey : JsonModel
{
    /// <summary>
    ...
    public UnmaskedPaykeyBankDetails? BankData
    {
        get
        {
            this._rawData.Freeze();
            return this._rawData.GetNullableClass<UnmaskedPaykeyBankDetails>("bank_data");
        }
        init
        {
            if (value == null)
    ...
    public UnmaskedPaykey() { }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public UnmaskedPaykey(UnmaskedPaykey unmaskedPaykey)
        : base(unmaskedPaykey) { }
#pragma warning restore CS8618

    public UnmaskedPaykey(IReadOnlyDictionary<string, JsonElement> rawData)
    {
...
#pragma warning disable CS8618
    [SetsRequiredMembers]
    UnmaskedPaykey(FrozenDictionary<string, JsonElement> rawData)
    {
        this._rawData = new(rawData);
    }
#pragma warning restore CS8618

    /// <inheritdoc cref="UnmaskedPaykeyFromRaw.FromRawUnchecked"/>
    public static UnmaskedPaykey FromRawUnchecked(IReadOnlyDictionary<string, JsonElement> rawData)
    {
        return new(FrozenDictionary.ToFrozenDictionary(rawData));
    }
}

class UnmaskedPaykeyFromRaw : IFromRawJson<UnmaskedPaykey>
{
    /// <inheritdoc/>
    public UnmaskedPaykey FromRawUnchecked(IReadOnlyDictionary<string, JsonElement> rawData) =>
        UnmaskedPaykey.FromRawUnchecked(rawData);
}
