...
/// </summary>
public record class PaykeyRefreshReviewParams : ParamsBase
{
    ...
    public PaykeyRefreshReviewParams() { }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public PaykeyRefreshReviewParams(PaykeyRefreshReviewParams paykeyRefreshReviewParams)
        : base(paykeyRefreshReviewParams)
    {
        this.ID = paykeyRefreshReviewParams.ID;
    }
...
#pragma warning restore CS8618
    ...
    public static PaykeyRefreshReviewParams FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawHeaderData,
        IReadOnlyDictionary<string, JsonElement> rawQueryData,
        string id
    )
    ...
    public virtual bool Equals(PaykeyRefreshReviewParams? other)
    {
        if (other == null)
        {
            return false;
