...
/// </summary>
public record class PaykeyUnblockParams : ParamsBase
{
    ...
    public string? Message
    {
        get
        {
            ...
            return this._rawBodyData.GetNullableClass<string>("message");
        }
    ...
    public PaykeyUnblockParams() { }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public PaykeyUnblockParams(PaykeyUnblockParams paykeyUnblockParams)
        : base(paykeyUnblockParams)
    {
        this.ID = paykeyUnblockParams.ID;

        this._rawBodyData = new(paykeyUnblockParams._rawBodyData);
    }
...
#pragma warning restore CS8618
    ...
    public static PaykeyUnblockParams FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawHeaderData,
        IReadOnlyDictionary<string, JsonElement> rawQueryData,
        IReadOnlyDictionary<string, JsonElement> rawBodyData,
        string id
    ...
    public virtual bool Equals(PaykeyUnblockParams? other)
    {
        if (other == null)
        {
            return false;
    ...
    public override Uri Url(ClientOptions options)
    {
        return new UriBuilder(
            options.BaseUrl.ToString().TrimEnd('/')
                + string.Format("/v1/paykeys/{0}/unblock", this.ID)
        )
        {
