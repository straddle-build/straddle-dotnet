...
/// </summary>
public record class PaykeyListUnmaskedParams : ParamsBase
{
    ...
    public PaykeyListUnmaskedParams() { }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public PaykeyListUnmaskedParams(PaykeyListUnmaskedParams paykeyListUnmaskedParams)
        : base(paykeyListUnmaskedParams)
    {
        this.ID = paykeyListUnmaskedParams.ID;
    }
...
#pragma warning restore CS8618
    ...
    public static PaykeyListUnmaskedParams FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawHeaderData,
        IReadOnlyDictionary<string, JsonElement> rawQueryData,
        string id
    )
    ...
    public virtual bool Equals(PaykeyListUnmaskedParams? other)
    {
        if (other == null)
        {
            return false;
