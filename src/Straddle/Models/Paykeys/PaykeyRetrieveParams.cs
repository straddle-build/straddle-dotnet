...
/// </summary>
public record class PaykeyRetrieveParams : ParamsBase
{
    ...
    public PaykeyRetrieveParams() { }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public PaykeyRetrieveParams(PaykeyRetrieveParams paykeyRetrieveParams)
        : base(paykeyRetrieveParams)
    {
        this.ID = paykeyRetrieveParams.ID;
    }
...
#pragma warning restore CS8618
    ...
    public static PaykeyRetrieveParams FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawHeaderData,
        IReadOnlyDictionary<string, JsonElement> rawQueryData,
        string id
    )
    ...
    public virtual bool Equals(PaykeyRetrieveParams? other)
    {
        if (other == null)
        {
            return false;
