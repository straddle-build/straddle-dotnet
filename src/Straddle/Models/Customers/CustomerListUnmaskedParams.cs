...
/// </summary>
public record class CustomerListUnmaskedParams : ParamsBase
{
    ...
    public CustomerListUnmaskedParams() { }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public CustomerListUnmaskedParams(CustomerListUnmaskedParams customerListUnmaskedParams)
        : base(customerListUnmaskedParams)
    {
        this.ID = customerListUnmaskedParams.ID;
    }
...
#pragma warning restore CS8618
    ...
    public static CustomerListUnmaskedParams FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawHeaderData,
        IReadOnlyDictionary<string, JsonElement> rawQueryData,
        string id
    )
    ...
    public virtual bool Equals(CustomerListUnmaskedParams? other)
    {
        if (other == null)
        {
            return false;
