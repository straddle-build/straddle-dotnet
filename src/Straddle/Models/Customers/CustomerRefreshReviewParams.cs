...
/// </summary>
public record class CustomerRefreshReviewParams : ParamsBase
{
    ...
    public CustomerRefreshReviewParams() { }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public CustomerRefreshReviewParams(CustomerRefreshReviewParams customerRefreshReviewParams)
        : base(customerRefreshReviewParams)
    {
        this.ID = customerRefreshReviewParams.ID;
    }
...
#pragma warning restore CS8618
    ...
    public static CustomerRefreshReviewParams FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawHeaderData,
        IReadOnlyDictionary<string, JsonElement> rawQueryData,
        string id
    )
    ...
    public virtual bool Equals(CustomerRefreshReviewParams? other)
    {
        if (other == null)
        {
            return false;
