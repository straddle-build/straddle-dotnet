...
public record class CustomerCreateParams : ParamsBase
{
    ...
    public required ApiEnum<string, CustomerType> Type
    {
        ...
        {
            this._rawBodyData.Freeze();
            return this._rawBodyData.GetNotNullClass<ApiEnum<string, CustomerType>>("type");
        }
    ...
    /// <summary>
    /// Customer compliance profile. When provided, the object must include all
    /// fields required for the customer type.
    /// </summary>
    ...
    public CustomerConfiguration? Config
    {
        ...
        {
            this._rawBodyData.Freeze();
            return this._rawBodyData.GetNullableClass<CustomerConfiguration>("config");
        }
        init
        {
            if (value == null)
