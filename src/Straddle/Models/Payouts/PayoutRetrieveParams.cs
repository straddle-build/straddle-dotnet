...
/// </summary>
public record class PayoutRetrieveParams : ParamsBase
{
    ...
    public PayoutRetrieveParams() { }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public PayoutRetrieveParams(PayoutRetrieveParams payoutRetrieveParams)
        : base(payoutRetrieveParams)
    {
        this.ID = payoutRetrieveParams.ID;
    }
...
#pragma warning restore CS8618
    ...
    public static PayoutRetrieveParams FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawHeaderData,
        IReadOnlyDictionary<string, JsonElement> rawQueryData,
        string id
    )
    ...
    public virtual bool Equals(PayoutRetrieveParams? other)
    {
        if (other == null)
        {
            return false;
