...
/// </summary>
public record class PayoutResubmitParams : ParamsBase
{
    ...
    /// <summary>
    /// Date when Straddle submits the resubmitted payout for processing. Defaults
    /// to today if omitted.
    /// </summary>
    ...
    public PayoutResubmitParams() { }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public PayoutResubmitParams(PayoutResubmitParams payoutResubmitParams)
        : base(payoutResubmitParams)
    {
        this.ID = payoutResubmitParams.ID;

        this._rawBodyData = new(payoutResubmitParams._rawBodyData);
    }
...
#pragma warning restore CS8618
    ...
    public static PayoutResubmitParams FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawHeaderData,
        IReadOnlyDictionary<string, JsonElement> rawQueryData,
        IReadOnlyDictionary<string, JsonElement> rawBodyData,
        string id
    ...
    public virtual bool Equals(PayoutResubmitParams? other)
    {
        if (other == null)
        {
            return false;
    ...
    public override Uri Url(ClientOptions options)
    {
        return new UriBuilder(
            options.BaseUrl.ToString().TrimEnd('/')
                + string.Format("/v1/payouts/{0}/resubmit", this.ID)
        )
        {
