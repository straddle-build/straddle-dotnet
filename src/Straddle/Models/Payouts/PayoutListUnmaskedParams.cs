...
/// </summary>
public record class PayoutListUnmaskedParams : ParamsBase
{
    ...
    public PayoutListUnmaskedParams() { }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public PayoutListUnmaskedParams(PayoutListUnmaskedParams payoutListUnmaskedParams)
        : base(payoutListUnmaskedParams)
    {
        this.ID = payoutListUnmaskedParams.ID;
    }
...
#pragma warning restore CS8618
    ...
    public static PayoutListUnmaskedParams FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawHeaderData,
        IReadOnlyDictionary<string, JsonElement> rawQueryData,
        string id
    )
    ...
    public virtual bool Equals(PayoutListUnmaskedParams? other)
    {
        if (other == null)
        {
            return false;
