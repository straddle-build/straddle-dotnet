...
/// </summary>
public record class PayoutUploadAuthorizationProofParams : ParamsBase
{
    ...
    public PayoutUploadAuthorizationProofParams() { }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public PayoutUploadAuthorizationProofParams(
        PayoutUploadAuthorizationProofParams payoutUploadAuthorizationProofParams
    )
        : base(payoutUploadAuthorizationProofParams)
    {
        this.ID = payoutUploadAuthorizationProofParams.ID;

        this._rawBodyData = new(payoutUploadAuthorizationProofParams._rawBodyData);
    }
...
#pragma warning restore CS8618
    ...
    public static PayoutUploadAuthorizationProofParams FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawHeaderData,
        IReadOnlyDictionary<string, JsonElement> rawQueryData,
        IReadOnlyDictionary<string, MultipartJsonElement> rawBodyData,
        string id
    ...
    public virtual bool Equals(PayoutUploadAuthorizationProofParams? other)
    {
        if (other == null)
        {
            return false;
