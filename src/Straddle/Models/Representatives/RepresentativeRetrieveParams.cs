...
/// </summary>
public record class RepresentativeRetrieveParams : ParamsBase
{
    ...
    public RepresentativeRetrieveParams() { }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public RepresentativeRetrieveParams(RepresentativeRetrieveParams representativeRetrieveParams)
        : base(representativeRetrieveParams)
    {
        this.RepresentativeID = representativeRetrieveParams.RepresentativeID;
    }
...
#pragma warning restore CS8618
    ...
    public static RepresentativeRetrieveParams FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawHeaderData,
        IReadOnlyDictionary<string, JsonElement> rawQueryData,
        string representativeID
    )
    ...
    public virtual bool Equals(RepresentativeRetrieveParams? other)
    {
        if (other == null)
        {
            return false;
