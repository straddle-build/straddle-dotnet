...
/// </summary>
public record class ChargeListUnmaskedParams : ParamsBase
{
    ...
    public ChargeListUnmaskedParams() { }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public ChargeListUnmaskedParams(ChargeListUnmaskedParams chargeListUnmaskedParams)
        : base(chargeListUnmaskedParams)
    {
        this.ID = chargeListUnmaskedParams.ID;
    }
...
#pragma warning restore CS8618
    ...
    public static ChargeListUnmaskedParams FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawHeaderData,
        IReadOnlyDictionary<string, JsonElement> rawQueryData,
        string id
    )
    ...
    public virtual bool Equals(ChargeListUnmaskedParams? other)
    {
        if (other == null)
        {
            return false;
