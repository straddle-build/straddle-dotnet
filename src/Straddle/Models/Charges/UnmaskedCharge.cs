...
[JsonConverter(typeof(JsonModelConverter<UnmaskedCharge, UnmaskedChargeFromRaw>))]
public sealed record class UnmaskedCharge : JsonModel
{
    /// <summary>
    ...
    public required ChargeConfiguration Config
    {
        ...
        {
            this._rawData.Freeze();
            return this._rawData.GetNotNullClass<ChargeConfiguration>("config");
        }
    ...
    public required ApiEnum<string, ConsentType> ConsentType
    {
        ...
        {
            this._rawData.Freeze();
            return this._rawData.GetNotNullClass<ApiEnum<string, ConsentType>>("consent_type");
        }
    ...
    public UnmaskedCharge() { }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public UnmaskedCharge(UnmaskedCharge unmaskedCharge)
        : base(unmaskedCharge) { }
#pragma warning restore CS8618

    public UnmaskedCharge(IReadOnlyDictionary<string, JsonElement> rawData)
    {
...
#pragma warning disable CS8618
    [SetsRequiredMembers]
    UnmaskedCharge(FrozenDictionary<string, JsonElement> rawData)
    {
        this._rawData = new(rawData);
    }
#pragma warning restore CS8618

    /// <inheritdoc cref="UnmaskedChargeFromRaw.FromRawUnchecked"/>
    public static UnmaskedCharge FromRawUnchecked(IReadOnlyDictionary<string, JsonElement> rawData)
    {
        return new(FrozenDictionary.ToFrozenDictionary(rawData));
    }
}

class UnmaskedChargeFromRaw : IFromRawJson<UnmaskedCharge>
{
    /// <inheritdoc/>
    public UnmaskedCharge FromRawUnchecked(IReadOnlyDictionary<string, JsonElement> rawData) =>
        UnmaskedCharge.FromRawUnchecked(rawData);
}
