...
/// </summary>
public record class ChargeResubmitParams : ParamsBase
{
    ...
    /// <summary>
    /// Date when Straddle submits the resubmitted charge for processing. Defaults
    /// to today if omitted.
    /// </summary>
    ...
    public ChargeResubmitParams() { }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public ChargeResubmitParams(ChargeResubmitParams chargeResubmitParams)
        : base(chargeResubmitParams)
    {
        this.ID = chargeResubmitParams.ID;

        this._rawBodyData = new(chargeResubmitParams._rawBodyData);
    }
...
#pragma warning restore CS8618
    ...
    public static ChargeResubmitParams FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawHeaderData,
        IReadOnlyDictionary<string, JsonElement> rawQueryData,
        IReadOnlyDictionary<string, JsonElement> rawBodyData,
        string id
    ...
    public virtual bool Equals(ChargeResubmitParams? other)
    {
        if (other == null)
        {
            return false;
    ...
    public override Uri Url(ClientOptions options)
    {
        return new UriBuilder(
            options.BaseUrl.ToString().TrimEnd('/')
                + string.Format("/v1/charges/{0}/resubmit", this.ID)
        )
        {
