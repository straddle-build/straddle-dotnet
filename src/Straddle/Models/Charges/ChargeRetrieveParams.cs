...
/// </summary>
public record class ChargeRetrieveParams : ParamsBase
{
    ...
    public ChargeRetrieveParams() { }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public ChargeRetrieveParams(ChargeRetrieveParams chargeRetrieveParams)
        : base(chargeRetrieveParams)
    {
        this.ID = chargeRetrieveParams.ID;
    }
...
#pragma warning restore CS8618
    ...
    public static ChargeRetrieveParams FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawHeaderData,
        IReadOnlyDictionary<string, JsonElement> rawQueryData,
        string id
    )
    ...
    public virtual bool Equals(ChargeRetrieveParams? other)
    {
        if (other == null)
        {
            return false;
