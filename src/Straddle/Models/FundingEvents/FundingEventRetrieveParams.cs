...
/// </summary>
public record class FundingEventRetrieveParams : ParamsBase
{
    ...
    public FundingEventRetrieveParams() { }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public FundingEventRetrieveParams(FundingEventRetrieveParams fundingEventRetrieveParams)
        : base(fundingEventRetrieveParams)
    {
        this.ID = fundingEventRetrieveParams.ID;
    }
...
#pragma warning restore CS8618
    ...
    public static FundingEventRetrieveParams FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawHeaderData,
        IReadOnlyDictionary<string, JsonElement> rawQueryData,
        string id
    )
    ...
    public virtual bool Equals(FundingEventRetrieveParams? other)
    {
        if (other == null)
        {
            return false;
